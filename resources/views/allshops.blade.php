        ...
        <div class="all-list-wrapper">
            ...
            <div class="menu-list-wrapper" id="divSortList">
                <ul id="sortListUl" class="list">
                    <li sortid='0' cate_id="0" class='current'><span class='items'>全部商品</span></li>
                    @foreach($cate as $v)
                    <li sortid='100' class="cateId" cate_id="{{$v->cate_id}}" reletype='1' linkaddr=''><span class='items'>{{$v->cate_name}}</span></li>
                    @endforeach
                    <li sortid='130' cate_id="0" reletype='1' linkaddr=''><span class='items'>其他商品</span></li>
                </ul>
            </div>
            ...
            <div class="good-list-wrapper">
                <div class="good-menu thin-bor-bottom">
                    <ul class="good-menu-list" id="ulOrderBy">
                        ...
                        <li orderflag="30" _type="self_price"><a href="javascript:;">价值 <span>↑</span></a></li>
                        <!--价值(由高到低30,由低到高31)-->
                    </ul>
                </div>
                <div id="box">
...
<input type="hidden" id="_token" value="{{csrf_token()}}">
<input type="hidden" id="cate_id" value="{{$id}}">
@endsection
